...
; 10 9 * * * NewAPI_MultiUser.js, tag=单站点签到, enabled=true, argument=host=example.com
; 如需只跑单站点下某个用户（可选）
; 10 9 * * * NewAPI_MultiUser.js, tag=单用户签到, enabled=true, argument=host=example.com&uid=1001
; 删除某个已保存用户（可选）
; 10 9 * * * NewAPI_MultiUser.js, tag=删除用户, enabled=true, argument=host=example.com&uid=1001&delete=1
; 查看当前已保存的站点和用户（可选）
; 10 9 * * * NewAPI_MultiUser.js, tag=查看已保存账号, enabled=true, argument=list=1
; 查看某个站点下已保存的用户（可选）
; 10 9 * * * NewAPI_MultiUser.js, tag=查看单站点账号, enabled=true, argument=list=1&host=example.com
